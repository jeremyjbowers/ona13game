        ...
        plugin.method = {
            ...
            setupQuiz: function() {
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.before('<a class="btn btn-success ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="btn btn-success ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
                        ...
                        if (plugin.config.disableResponseMessaging || plugin.config.completionResponseMessaging) {
                            questionHTML.append('<a href="#" class="btn btn-success ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + plugin.config.nextQuestionText + '</a>');
                        } else {
                            questionHTML.append('<a href="#" class="btn btn-success ' + nextQuestionClass + '">' + plugin.config.nextQuestionText + '</a>');
                            questionHTML.append('<a href="#" class="btn btn-success ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                        }
