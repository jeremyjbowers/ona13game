...
var quizJSON = {
    "info": {
        "name":    "Smart or Dumb?",
        "main":    "<p>If you're at ONA, you probably have a smartphone (and then some). But the majority of people around the world -- and certain demographics -- in the U.S. only have dumbphones, old-school cell phones without internet or data plans. Take our quiz, based on an ONA talk by Columbia University Graduate School of Journalism professor Susan McGregor and a recent<ahref=\"http://pewinternet.org/Reports/2013/Smartphone-Ownership-2013/Findings.aspx\">Pew Research Center study</a>, to find out if you should be thinking more about designing for phones that only have voice and text capabilities.</p>",
    ...
    "questions": [
      ...
      /*  { // Question 2 - Multiple Choice, Multiple True Answers, Select Any
        ...
        { // Question 5
            ...
            "correct": "<p><span>DUMB</span> Rural audiences are more likely to have a dumbphone, especially in developing countries.</p>",
            "incorrect": "<p><span>SMART</span> Urban audiences are more likely to have a smartphone.</p>" // no comma here
        }, // no comma here
